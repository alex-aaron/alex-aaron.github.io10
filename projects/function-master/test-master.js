(function(){
  ...
  QUnit.test("Functions can access/modify variables in parent scope.", function(assert){
    var outside_the_function = null; // variable declared in parent scope
    function yay(){
      var inside_the_function = "can you see me?"; // nested function scoped variable
      outside_the_function = inside_the_function; // accessing the variable from the parent
      // scope and reassigning it
    }
